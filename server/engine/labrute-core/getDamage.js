...
// Original source: labrute/server/src/utils/fight/getDamage.ts

const { getFighterStat } = require('./getFighterStat');

// Constants for fight stats
const FightStat = {
...
// Skill damage modifiers - will be populated from core data
const SkillDamageModifiers = [];

/**
 * Calculate damage between fighter and opponent
 ...
 */
const getDamage = (fighter, opponent, thrown) => {
  const base = thrown
    ? thrown.damage
...
module.exports = { getDamage, FightStat, SkillName, WeaponName };